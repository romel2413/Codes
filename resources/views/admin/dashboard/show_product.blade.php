            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <main class="table_main">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ url('/add_product') }}" method="POST"
                                        ...
                                        <div class="div_design">
                                            ...
                                            <input class="text_color" type="number" min="0" name="stock"
                                                id="" placeholder="Write a Stock " required="">
                                        </div>

                                        <div class="div_design">
                                            <label for="">Product Price :</label>
                                            <input class="text_color" type="number" min="1" name="price"
                                                id="" placeholder="Write a Price " required="">
                                        </div>
                                        <div class="div_design">
                                            <label for="">Product Discount :</label>
                                            <input class="text_color" type="number" min="1" name="discount_price"
                                                id="" placeholder="Write a Discount " required="">
                                        </div>
                        ...
                        <div class="center">
                            <div class="buttonss">
                                <a href="{{ route('trash_product') }}" style="border-radius: 5rem;"
                                    class="btn btn-outline-secondary" id="deleteAllSelectedRecord">
                                    <i class="fas fa-recycle"></i> Trashed
                                </a><br>
                            </div>
                                                ...
                                                <tr class="td_color">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-danger"
                                                            ...
                                                            href="{{ url('delete_product', $productDB->id) }}">
                                                            <i class="fas fa-trash"></i> Delete
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-outline-success"
                                                            href="{{ url('update_product', $productDB->id) }}">

<section class="slider_section">
    <div class="slider_bg_box">
        <img src="{{ asset('home/images/aaa.jpg') }}" alt="">
    </div>
    <div id="customCarousel1" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-6"> <!-- Adjust the column size for responsiveness -->
                            <div class="detail-box">
                                ...
                                <p>
                                    sdghdsfgk;jdsfhgkjldsbg j,dhfhgvbsdiyutfbfdljghsdfbgiuysdfghbgljkdfsbgo68sdfghljksdfbgoyudsfgyiodfslgyu
                                </p>
                                <div class="btn-box">
